MPI Multiphase all-Mach VOF solver for Investigating Turbulence of Bubble Bursting
  ...
  Results were validated via solver order of accuracy, the effect of surface tension on shrinking under non-adiabatic conditions, and the drag coefficient given various deformabilities.
  
  Turbulence analysis was then conducted, comparing the steady and un-steady profiles
